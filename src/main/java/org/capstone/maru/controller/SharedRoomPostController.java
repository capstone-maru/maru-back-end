...
public class SharedRoomPostController {
    ...
    public String postNewStudioRoomPost(
        @ModelAttribute StudioRoomPostRequest studioRoomPostInfo
    ) {
        log.info("[Debug Controller] data: {}", studioRoomPostInfo.postInfoData());
        log.info("[Debug Controller] data: {}", studioRoomPostInfo.transactionInfoData());
        log.info("[Debug Controller] data: {}", studioRoomPostInfo.roomInfoData());
        log.info("[Debug Controller] data: {}", studioRoomPostInfo.locationInfoData());
